...
export function DemoSite({ template }: { template: TemplateItem }) {
  ...
  return (
    <main className={`sample-site ${template.category} ${template.slug}`} style={style}>
